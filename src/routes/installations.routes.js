...
router.get('/', requireAuth, authorize('installations:read','crew:*'), ctl.list);
router.get('/:id', requireAuth, authorize('installations:read','crew:*'), ctl.getById);
...
router.post('/:id/crew', requireAuth, authorize('installations:write','crew:*'), ctl.assignCrew);
router.patch('/:id/status', requireAuth, authorize('installations:write','crew:*'), ctl.updateStatus);

// PATCH 
router.patch('/:id',   requireAuth, authorize('installations:write'), ctl.update);

//installations items
router.get('/:id/items',    requireAuth, authorize('installations:read','crew:*'),  ctl.listItems);
...
//crew assign
router.get('/:id/crew',     requireAuth, authorize('installations:read','crew:*'),  ctl.listCrew);
...
// media
router.get('/:id/media',  requireAuth, authorize('installations:read','crew:*'),  listForInstallation);
router.post('/:id/media', requireAuth, authorize('installations:write','crew:*'), createForInstallation);
